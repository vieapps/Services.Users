...
namespace net.vieapps.Services.Users
{
	internal static class Global
	{
		...
		internal static Services.Session GetSession(NameValueCollection header, NameValueCollection query, string ipAddress, Uri urlReferrer = null, string agentString = null)
		{
